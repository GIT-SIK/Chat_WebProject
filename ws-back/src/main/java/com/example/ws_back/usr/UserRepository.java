...
public interface UserRepository extends JpaRepository<User, Long> {
	...
	@Query(value = "SELECT * FROM TB_USER_MA WHERE USER_ID LIKE UPPER(:id)", nativeQuery = true)
	...
	@Query (value = "SELECT * FROM TB_USER_MA WHERE USER_ID LIKE UPPER(:id%) AND IS_PUBLIC = 'true'", nativeQuery = true)
